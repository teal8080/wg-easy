...
| `WG_PORT` | `51820` | `12345` | The public UDP port of your VPN server if WG_CLIENTS_PORT was not set. WireGuard will listen on that (otherwise default) inside the Docker container. |
| `WG_CLIENTS_PORT` | `51820` | `12345` | Overrides WG_PORT as the public UDP port of your VPN server. |
